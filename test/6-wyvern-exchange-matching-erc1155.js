...
const {wrap,hashOrder,ZERO_BYTES32,randomUint,NULL_SIG} = require('./aux')
...
contract('WyvernExchange', (accounts) =>
	...
	it('matches erc1155 <> erc20 signed orders, matched right, real static call',async () => 
		...
		await Promise.all([erc20.approve(proxy1,price,{from: account_a}),erc1155.setApprovalForAll(proxy2,true,{from: account_b})])
		await Promise.all([erc20.mint(account_a,price),erc1155.mint(account_b,tokenId,1)])
		...
		const one = {registry: registry.address, maker: account_a, staticTarget: statici.address, staticSelector: selectorOne, staticExtradata: extradataOne, maximumFill: '1', listingTime: '0', expirationTime: '10000000000', salt: '3358'}
