...
contract('WyvernExchange', (accounts) => {
  ...
  it('should correctly hash order', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[0], staticTarget: ZERO_ADDRESS, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '0', salt: '0'}
  ...
  it('should not allow set-fill to same fill', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[1], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '6'}
  ...
  it('should validate valid order parameters', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[0], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '0'}
  ...
  it('should not validate order parameters with invalid staticTarget', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[0], staticTarget: ZERO_ADDRESS, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '0'}
        return exchange.validateOrderParameters(example).then(valid => {
  ...
  it('should not validate order parameters with listingTime after now', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[0], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '1000000000000', expirationTime: '1000000000000', salt: '0'}
        return exchange.validateOrderParameters(example).then(valid => {
          assert.equal(false, valid, 'Should not have validated')
        })
      })
  ...
  it('should not validate order parameters with expirationTime before now', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[0], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '0', salt: '0'}
        return exchange.validateOrderParameters(example).then(valid => {
          assert.equal(false, valid, 'Should not have validated')
        })
      })
  ...
  it('should validate valid authorization by signature', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[1], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '100230'}
  ...
  it('should not allow approval twice', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[1], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '1010'}
  ...
  it('should not allow approval from another user', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[1], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '10101234'}
  ...
  it('should validate valid authorization by approval', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[1], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '10'}
        return exchange.approveOrder(example, false, {from: accounts[1]}).then(() => {
          const hash = hashOrder(example)
  ...
  it('should validate valid authorization by hash-approval', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[1], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '1'}
        const hash = hashOrder(example)
  ...
  it('should validate valid authorization by maker', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[0], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '5'}
        const hash = hashOrder(example)
  ...
  it('should not validate authorization without signature', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[1], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '0'}
        const hash = hashOrder(example)
  ...
  it('should not validate cancelled order', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[0], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '20'}
  ...
  it('should allow order cancellation by maker', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[0], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '3'}
        return exchange.setOrderFill(example, 1).then(() => {})
      })
  })
  ...
  it('should allow order cancellation by non-maker', () => {
    return withExchangeAndRegistry()
      .then(({exchange, registry}) => {
        const example = {maker: accounts[1], staticTarget: exchange.inst.address, staticExtradata: '0x', maximumFill: '1', listingTime: '0', expirationTime: '1000000000000', salt: '4'}
        return exchange.setOrderFill(example, 1).then(() => {})
      })
  })
})
